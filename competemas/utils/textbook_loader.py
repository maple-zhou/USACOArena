...
class TextbookLoader:
    ...
    def __init__(self, data_path: Optional[str] = None):
        if data_path is None:
            ...
            possible_paths = [
                os.path.join(current_dir, "..", "..", "data", "corpuses", "cpbook_v2.json"),
                "data/corpuses/cpbook_v2.json"  # Fallback to the original path
            ]
            ...
            for path in possible_paths:
                ...
                self.data_path = "data/corpuses/cpbook_v2.json"  # Use as default if nothing found
        else:
