"""Utility for submitting code and custom test cases through the Hydro-backed judge.
...
and the script will invoke the Hydro-backed judge adapter against the
configured Hydro base URL.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Submit code and test cases through the Hydro-backed judge."
    )
    ...
    parser.add_argument(
        ...
        help="Hydro base URL (compatibility flag name retained)",
    )
    ...
    parser.add_argument(
        "--curl-log",
        help="Write the exact curl command for each outbound request to this file",
    )
    parser.add_argument(
        "--stdin-root",
        help="Optional root used to derive relative input paths for custom cases",
    )
