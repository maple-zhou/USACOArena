...
#     response = """
# An elegant solution to this problem involves dynamic programming, leveraging a key insight about the nature of the possible scores.
...
```
    """
    action = action_parser.parse_action(response)
    # print(action)